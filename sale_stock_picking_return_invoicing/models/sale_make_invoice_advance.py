...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _create_invoice(self, order, so_line, amount):
        '''
        Invocamos el método _create_invoice para completar los datos de las facturas que son creadas
        a partir de las ordenes de venta por porcentaje o valor fijo
        '''
...
class SaleRefundInvoice(models.TransientModel):
    _name = "sale.refund.invoice"
    _description = "Sales Refund Invoice Wizard"
